...
class ConfigLoader:
    ...
    def _load_specific_config(self, config_name: str) -> Dict[str, Any]:
        ...
        if user_config_file.exists():
            user_config = self._load_toml_file(user_config_file)
            # 根据配置名称提取相关配置
            relevant_user_config = self._extract_relevant_user_config(user_config, config_name)
    ...
    def _extract_relevant_user_config(self, user_config: Dict[str, Any], config_name: str) -> Dict[str, Any]:
